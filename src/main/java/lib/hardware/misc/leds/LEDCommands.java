...
public class LEDCommands {
     ...
     * @return the command
     */
    public static Command getAnimateCommand(LEDStripAnimationSettings.LEDAnimationSettings settings, lib.hardware.misc.leds.LEDStrip... ledStrips) {
        return new StartEndCommand(
                () -> {
                    runForLEDs(lib.hardware.misc.leds.LEDStrip::clearLEDColors, ledStrips);
                    runForLEDs(ledStrip -> ledStrip.setCurrentAnimation(lib.hardware.misc.leds.LEDStrip.applyAnimation(ledStrip, settings)), ledStrips);
                },
                () -> runForLEDs(lib.hardware.misc.leds.LEDStrip::clearLEDColors, ledStrips),
                ledStrips
     ...
     * @return the command
     */
    public static Command getAnimateCommand(LEDStripAnimationSettings.LEDAnimationSettings settings, lib.hardware.misc.leds.LEDBoard ledBoard) {
        return new StartEndCommand(
                () -> {
                    runForLEDs(lib.hardware.misc.leds.LEDStrip::clearLEDColors, ledBoard.getLEDStrips());
                    runForLEDs(ledStrip -> ledStrip.setCurrentAnimation(lib.hardware.misc.leds.LEDStrip.applyAnimation(ledStrip, settings)), ledBoard.getLEDStrips());
                },
                () -> runForLEDs(lib.hardware.misc.leds.LEDStrip::clearLEDColors, ledBoard.getLEDStrips()),
                ledBoard
        ).ignoringDisable(true);
     ...
     * @return the command
     */
    public static Command getStaticColorCommand(Color color, lib.hardware.misc.leds.LEDStrip... ledStrips) {
        return new StartEndCommand(
                () -> {
                    runForLEDs(lib.hardware.misc.leds.LEDStrip::clearLEDColors, ledStrips);
     ...
     * @return the command
     */
    public static Command getStaticColorCommand(Color color, lib.hardware.misc.leds.LEDBoard ledBoard) {
        return new StartEndCommand(
                () -> {
                    runForLEDs(lib.hardware.misc.leds.LEDStrip::clearLEDColors, ledBoard.getLEDStrips());
     ...
     * @return the command
     */
    public static Command getBlinkCommand(Color color, double speed, lib.hardware.misc.leds.LEDStrip... ledStrips) {
        return new StartEndCommand(
                () -> {
                    runForLEDs(lib.hardware.misc.leds.LEDStrip::clearLEDColors, ledStrips);
     ...
     * @return the command
     */
    public static Command getBlinkCommand(Color color, double speed, lib.hardware.misc.leds.LEDBoard ledBoard) {
        return new StartEndCommand(
                () -> {
                    runForLEDs(lib.hardware.misc.leds.LEDStrip::clearLEDColors, ledBoard.getLEDStrips());
     ...
     * @return the command
     */
    public static Command getBreatheCommand(Color color, int numberOfBreathingLEDs, double speed, boolean inverted, LarsonAnimation.BounceMode bounceMode, lib.hardware.misc.leds.LEDStrip... ledStrips) {
        return new StartEndCommand(
                () -> {
                    runForLEDs(lib.hardware.misc.leds.LEDStrip::clearLEDColors, ledStrips);
     ...
     * @return the command
     */
    public static Command getBreatheCommand(Color color, int numberOfBreathingLEDs, int speedLEDsPerSecond, int ledSpacing, boolean inverted, lib.hardware.misc.leds.LEDBoard ledBoard) {
     ...
     * @return the command
     */
    public static Command getColorFlowCommand(Color color, double speed, boolean inverted, lib.hardware.misc.leds.LEDStrip... ledStrips) {
        return new StartEndCommand(
                () -> {
                    runForLEDs(lib.hardware.misc.leds.LEDStrip::clearLEDColors, ledStrips);
     ...
     * @return the command
     */
    public static Command getColorFlowCommand(Color color, double speed, boolean inverted, lib.hardware.misc.leds.LEDBoard ledBoard) {
        return new StartEndCommand(
                () -> {
                    runForLEDs(lib.hardware.misc.leds.LEDStrip::clearLEDColors, ledBoard.getLEDStrips());
     ...
     * @return the command
     */
    public static Command getAlternateColorCommand(Color firstColor, Color secondColor, lib.hardware.misc.leds.LEDStrip... ledStrips) {
        return new StartEndCommand(
                () -> {
                    runForLEDs(lib.hardware.misc.leds.LEDStrip::clearLEDColors, ledStrips);
     ...
     * @return the command
     */
    public static Command getAlternateColorCommand(Color firstColor, Color secondColor, lib.hardware.misc.leds.LEDBoard ledBoard) {
        return new StartEndCommand(
                () -> {
                    runForLEDs(lib.hardware.misc.leds.LEDStrip::clearLEDColors, ledBoard.getLEDStrips());
     ...
     * @return the command
     */
    public static Command getSectionColorCommand(Supplier<Color>[] colors, lib.hardware.misc.leds.LEDStrip... ledStrips) {
        return new StartEndCommand(
                () -> {
                    runForLEDs(lib.hardware.misc.leds.LEDStrip::clearLEDColors, ledStrips);
     ...
     * @return the command
     */
    public static Command getSectionColorCommand(Supplier<Color>[] colors, lib.hardware.misc.leds.LEDBoard ledBoard) {
        return new StartEndCommand(
                () -> {
                    runForLEDs(lib.hardware.misc.leds.LEDStrip::clearLEDColors, ledBoard.getLEDStrips());
     ...
     * @return the command
     */
    public static Command getRainbowCommand(double brightness, double speed, boolean inverted, lib.hardware.misc.leds.LEDStrip... ledStrips) {
        return new StartEndCommand(
                () -> {
                    runForLEDs(lib.hardware.misc.leds.LEDStrip::clearLEDColors, ledStrips);
     ...
     * @return the command
     */
    public static Command getRainbowCommand(double brightness, double speed, boolean inverted, lib.hardware.misc.leds.LEDBoard ledBoard) {
        return new StartEndCommand(
                () -> {
                    runForLEDs(lib.hardware.misc.leds.LEDStrip::clearLEDColors, ledBoard.getLEDStrips());
     ...
     * @return the command
     */
    public static Command getSetImageCommand(String filePath, lib.hardware.misc.leds.LEDBoard ledBoard) {
        return new StartEndCommand(
     ...
     * @return the command
     */
    public static Command getSetBoardAnimationCommand(String[] filePaths, int framesPerSecond, boolean shouldLoop, boolean shouldKeepLastFrame, lib.hardware.misc.leds.LEDBoard ledBoard) {
        return new FunctionalCommand(
     ...
     * @return the command
     */
    public static Command getDefaultAnimateCommand(LEDStripAnimationSettings.LEDAnimationSettings settings, lib.hardware.misc.leds.LEDStrip... ledStrips) {
        return new StartEndCommand(
                () -> {
                    runForLEDs(lib.hardware.misc.leds.LEDStrip::clearLEDColors, ledStrips);
                    runForLEDs(ledStrip -> ledStrip.setCurrentAnimation(lib.hardware.misc.leds.LEDStrip.applyAnimation(ledStrip, settings)), ledStrips);
     ...
     */
    private static void runForLEDs(Consumer<lib.hardware.misc.leds.LEDStrip> action, lib.hardware.misc.leds.LEDStrip... ledStrips) {
        if (ledStrips.length == 0)
            ledStrips = lib.hardware.misc.leds.LEDStrip.LED_STRIPS;
