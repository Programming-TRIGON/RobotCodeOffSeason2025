...
import lib.hardware.rev.spark.io.RealSparkIO;
import lib.hardware.rev.spark.io.SimulationSparkIO;
...
public class SparkMotor {
    ...
    private final lib.hardware.rev.spark.SparkIO motorIO;
    private final lib.hardware.rev.spark.SparkInputs motorInputs;
     ...
     */
    public void registerThreadedSignal(lib.hardware.rev.spark.SparkSignal signal) {
        final lib.hardware.rev.spark.SparkStatusSignal statusSignal = signal.getStatusSignal(motorIO.getMotor(), motorIO.getEncoder());
     ...
     */
    public void registerSignal(lib.hardware.rev.spark.SparkSignal signal) {
     ...
     * @return the signal
     */
    public double getSignal(lib.hardware.rev.spark.SparkSignal signal) {
    ...
    private lib.hardware.rev.spark.SparkIO createSparkIO(int id, SparkType sparkType) {
