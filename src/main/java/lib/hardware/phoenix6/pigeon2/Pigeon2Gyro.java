package lib.hardware.phoenix6.pigeon2;
...
import lib.hardware.phoenix6.pigeon2.io.RealPigeon2IO;
import lib.hardware.phoenix6.pigeon2.io.SimulationPigeon2IO;
...
public class Pigeon2Gyro {
    ...
    private final lib.hardware.phoenix6.pigeon2.Pigeon2IO gyroIO;
    ...
    public double getSignal(lib.hardware.phoenix6.pigeon2.Pigeon2Signal signal) {
        return gyroInputs.getSignal(signal.name);
    }

    public double[] getThreadedSignal(lib.hardware.phoenix6.pigeon2.Pigeon2Signal signal) {
        return gyroInputs.getThreadedSignal(signal.name);
    }

    public void registerSignal(lib.hardware.phoenix6.pigeon2.Pigeon2Signal signal, double updateFrequencyHertz) {
        gyroInputs.registerSignal(pigeon2SignalToStatusSignal(signal), updateFrequencyHertz);
    }

    public void registerThreadedSignal(lib.hardware.phoenix6.pigeon2.Pigeon2Signal signal, double updateFrequencyHertz) {
    ...
    private lib.hardware.phoenix6.pigeon2.Pigeon2IO generateIO(int id, String canbus) {
