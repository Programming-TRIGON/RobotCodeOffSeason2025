...
import lib.hardware.phoenix6.cancoder.io.RealCANcoderIO;
import lib.hardware.phoenix6.cancoder.io.SimulationCANcoderIO;
...
public class CANcoderEncoder {
     ...
     * @return the signal
     */
    public double getSignal(lib.hardware.phoenix6.cancoder.CANcoderSignal signal) {
     ...
     */
    public double[] getThreadedSignal(lib.hardware.phoenix6.cancoder.CANcoderSignal signal) {
     ...
     */
    public void registerSignal(lib.hardware.phoenix6.cancoder.CANcoderSignal signal, double updateFrequencyHertz) {
     ...
     * @param updateFrequencyHertz the frequency at which the signal will be updated
     */
    public void registerThreadedSignal(lib.hardware.phoenix6.cancoder.CANcoderSignal signal, double updateFrequencyHertz) {
