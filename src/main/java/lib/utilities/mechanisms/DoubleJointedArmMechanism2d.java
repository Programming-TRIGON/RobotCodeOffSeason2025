...
public class DoubleJointedArmMechanism2d {
    ...
    public DoubleJointedArmMechanism2d(String key, Color mechanismColor) {
        this(key, lib.utilities.mechanisms.MechanismConstants.MECHANISM_LINE_LENGTH, lib.utilities.mechanisms.MechanismConstants.MECHANISM_LINE_LENGTH, mechanismColor);
    }
    ...
    public DoubleJointedArmMechanism2d(String name, double firstJointLength, double secondJointLength, Color mechanismColor) {
        ...
        final double mechanismMiddle = lib.utilities.mechanisms.MechanismConstants.LIGAMENT_END_TO_EDGE_RATIO * (firstJointLength + secondJointLength);
        ...
        this.currentPositionFirstLigament = root.append(new LoggedMechanismLigament2d("ZCurrentPositionFirstLigament", firstJointLength, 0, lib.utilities.mechanisms.MechanismConstants.MECHANISM_LINE_WIDTH, new Color8Bit(mechanismColor)));
        this.currentPositionSecondLigament = currentPositionFirstLigament.append(new LoggedMechanismLigament2d("ZCurrentPositionSecondLigament", secondJointLength, 0, lib.utilities.mechanisms.MechanismConstants.MECHANISM_LINE_WIDTH, new Color8Bit(mechanismColor)));
        this.targetPositionFirstLigament = root.append(new LoggedMechanismLigament2d("TargetPositionFirstLigament", firstJointLength, 0, lib.utilities.mechanisms.MechanismConstants.MECHANISM_LINE_WIDTH, lib.utilities.mechanisms.MechanismConstants.GRAY));
        this.targetPositionSecondLigament = targetPositionFirstLigament.append(new LoggedMechanismLigament2d("TargetPositionSecondLigament", secondJointLength, 0, lib.utilities.mechanisms.MechanismConstants.MECHANISM_LINE_WIDTH, MechanismConstants.GRAY));
    }
