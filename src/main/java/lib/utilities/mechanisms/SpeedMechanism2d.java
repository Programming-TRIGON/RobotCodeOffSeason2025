...
public class SpeedMechanism2d {
    ...
    public SpeedMechanism2d(String name, double maximumDisplayableVelocity, double deadband) {
        ...
        this.currentVelocityLigament = root.append(new LoggedMechanismLigament2d("ZCurrentVelocityLigament", 0, 0, lib.utilities.mechanisms.MechanismConstants.MECHANISM_LINE_WIDTH, lib.utilities.mechanisms.MechanismConstants.BLUE));
        this.currentVelocityTopArrowLigament = currentVelocityLigament.append(new LoggedMechanismLigament2d("ZCurrentVelocityTopArrowLigament", lib.utilities.mechanisms.MechanismConstants.ARROW_LENGTH_SCALE * maximumDisplayableVelocity, lib.utilities.mechanisms.MechanismConstants.ZERO_TOP_ANGLE, lib.utilities.mechanisms.MechanismConstants.MECHANISM_LINE_WIDTH, lib.utilities.mechanisms.MechanismConstants.BLUE));
        this.currentVelocityBottomArrowLigament = currentVelocityLigament.append(new LoggedMechanismLigament2d("ZCurrentVelocityBottomArrowLigament", lib.utilities.mechanisms.MechanismConstants.ARROW_LENGTH_SCALE * maximumDisplayableVelocity, lib.utilities.mechanisms.MechanismConstants.ZERO_BOTTOM_ANGLE, lib.utilities.mechanisms.MechanismConstants.MECHANISM_LINE_WIDTH, lib.utilities.mechanisms.MechanismConstants.BLUE));

        this.targetVelocityLigament = root.append(new LoggedMechanismLigament2d("TargetVelocityLigament", 0, 0, lib.utilities.mechanisms.MechanismConstants.MECHANISM_LINE_WIDTH, lib.utilities.mechanisms.MechanismConstants.GRAY));
        this.targetVelocityTopArrowLigament = targetVelocityLigament.append(new LoggedMechanismLigament2d("TargetVelocityTopArrowLigament", lib.utilities.mechanisms.MechanismConstants.ARROW_LENGTH_SCALE * maximumDisplayableVelocity, lib.utilities.mechanisms.MechanismConstants.ZERO_TOP_ANGLE, lib.utilities.mechanisms.MechanismConstants.MECHANISM_LINE_WIDTH, lib.utilities.mechanisms.MechanismConstants.GRAY));
        this.targetVelocityBottomArrowLigament = targetVelocityLigament.append(new LoggedMechanismLigament2d("TargetVelocityBottomArrowLigament", lib.utilities.mechanisms.MechanismConstants.ARROW_LENGTH_SCALE * maximumDisplayableVelocity, lib.utilities.mechanisms.MechanismConstants.ZERO_BOTTOM_ANGLE, lib.utilities.mechanisms.MechanismConstants.MECHANISM_LINE_WIDTH, lib.utilities.mechanisms.MechanismConstants.GRAY));
    }
    ...
    private Color8Bit velocityToColor(double velocity) {
        if (velocity > deadband)
            return lib.utilities.mechanisms.MechanismConstants.GREEN;
        else if (velocity < -deadband)
            return lib.utilities.mechanisms.MechanismConstants.RED;
        return lib.utilities.mechanisms.MechanismConstants.BLUE;
    }
    ...
    private void setArrowAngle(double velocity, LoggedMechanismLigament2d topLigament, LoggedMechanismLigament2d bottomLigament) {
        if (velocity > deadband) {
            topLigament.setAngle(lib.utilities.mechanisms.MechanismConstants.POSITIVE_TOP_ANGLE);
            bottomLigament.setAngle(lib.utilities.mechanisms.MechanismConstants.POSITIVE_BOTTOM_ANGLE);
        } else if (velocity < -deadband) {
            topLigament.setAngle(lib.utilities.mechanisms.MechanismConstants.NEGATIVE_TOP_ANGLE);
            bottomLigament.setAngle(lib.utilities.mechanisms.MechanismConstants.NEGATIVE_BOTTOM_ANGLE);
        } else {
            topLigament.setAngle(lib.utilities.mechanisms.MechanismConstants.ZERO_TOP_ANGLE);
