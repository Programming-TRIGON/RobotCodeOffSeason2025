...
public class SingleJointedArmMechanism2d {
    ...
    public SingleJointedArmMechanism2d(String key, Color mechanismColor) {
        this(key, lib.utilities.mechanisms.MechanismConstants.MECHANISM_LINE_LENGTH, mechanismColor);
    }
    ...
    public SingleJointedArmMechanism2d(String name, double armLength, Color mechanismColor) {
        ...
        final double mechanismMiddle = lib.utilities.mechanisms.MechanismConstants.LIGAMENT_END_TO_EDGE_RATIO * armLength;
        ...
        this.currentPositionLigament = root.append(new LoggedMechanismLigament2d("ZCurrentPositionLigament", armLength, 0, lib.utilities.mechanisms.MechanismConstants.MECHANISM_LINE_WIDTH, new Color8Bit(mechanismColor)));
        this.targetPositionLigament = root.append(new LoggedMechanismLigament2d("TargetPositionLigament", armLength, 0, lib.utilities.mechanisms.MechanismConstants.MECHANISM_LINE_WIDTH, MechanismConstants.GRAY));
    }
