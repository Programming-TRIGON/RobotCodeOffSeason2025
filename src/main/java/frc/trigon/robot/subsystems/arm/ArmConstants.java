...
public class ArmConstants {
    ...
    public enum ArmState {
        ...
        SCORE_L1(Rotation2d.fromDegrees(75), Rotation2d.fromDegrees(75), 4),
        SCORE_L2(Rotation2d.fromDegrees(180), Rotation2d.fromDegrees(180), 4),
        SCORE_L3(Rotation2d.fromDegrees(90), Rotation2d.fromDegrees(90), 4),
        SCORE_L4(Rotation2d.fromDegrees(90), Rotation2d.fromDegrees(90), 4),
