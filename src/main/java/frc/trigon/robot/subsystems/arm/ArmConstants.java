...
public class ArmConstants {
    ...
    public enum ArmState {
        ...
        PREPARE_L1(Rotation2d.fromDegrees(80), 0),
        PREPARE_L2(Rotation2d.fromDegrees(95), 0),
        PREPARE_L3(Rotation2d.fromDegrees(95), 0),
        PREPARE_L4(Rotation2d.fromDegrees(95), 0),
        PREPARE_NET(Rotation2d.fromDegrees(90), HOLD_ALGAE.targetEndEffectorVoltage),
        SCORE_NET(Rotation2d.fromDegrees(160), 4),
        PREPARE_PROCESSOR(Rotation2d.fromDegrees(90), HOLD_ALGAE.targetEndEffectorVoltage),
